...
function Information() {
    return (
        <div className='w-screen h-screen bg-green-50'>
            ...
            <div className="xl:w-7/12 xl:h-1/4 sm:left-0 sm:w-auto sm:h-auto rounded-2xl bg-green-950 p-7 relative top-2/4 md:left-16">
                <p className='sans-serif text-neutral-100 text-2xl mt-1 font-bold'>Send us a message!</p>
